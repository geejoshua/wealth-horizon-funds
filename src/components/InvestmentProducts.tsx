  ...
  bonds: [
    {
      ...
      term: '3-5 years',
      minInvestment: '$1,000',
      description: 'A diversified portfolio of corporate bonds with steady returns and moderate risk.',
      icon: <BadgeDollarSign className="h-10 w-10 p-2 bg-blue-50 text-wealth-blue rounded-lg" />
    },
    {
      ...
      term: '5-10 years',
      minInvestment: '$2,500',
      description: 'Long-term government bonds offering stable and predictable returns with minimal risk.',
      icon: <Shield className="h-10 w-10 p-2 bg-green-50 text-emerald-600 rounded-lg" />
    },
    {
      ...
      term: '2-4 years',
      minInvestment: '$5,000',
      description: 'Higher-yielding corporate bonds for investors seeking stronger returns with increased risk tolerance.',
      icon: <TrendingUp className="h-10 w-10 p-2 bg-amber-50 text-amber-600 rounded-lg" />
    },
  ],
  treasuryBills: [
    {
      ...
      term: '3 months',
      minInvestment: '$1,000',
      description: 'Short-term government securities with virtually no risk and competitive returns.',
      icon: <Shield className="h-10 w-10 p-2 bg-green-50 text-emerald-600 rounded-lg" />
    },
    {
      ...
      term: '6 months',
      minInvestment: '$1,000',
      description: 'Medium-term treasury bills offering slightly higher returns than 3-month bills.',
      icon: <Shield className="h-10 w-10 p-2 bg-green-50 text-emerald-600 rounded-lg" />
    },
    {
      ...
      term: '1 year',
      minInvestment: '$1,000',
      description: 'One-year government securities with guaranteed returns and maximum security.',
      icon: <Shield className="h-10 w-10 p-2 bg-green-50 text-emerald-600 rounded-lg" />
    },
  ],
  mutualFunds: [
    {
      ...
      term: '5+ years',
      minInvestment: '$5,000',
      description: 'Focused on capital appreciation with investments in high-growth potential sectors.',
      icon: <TrendingUp className="h-10 w-10 p-2 bg-amber-50 text-amber-600 rounded-lg" />
    },
    {
      name: 'Income Fund',
      ...
      term: '3+ years',
      minInvestment: '$2,500',
      description: 'Balanced investment approach prioritizing regular income and moderate growth.',
      icon: <BadgeDollarSign className="h-10 w-10 p-2 bg-blue-50 text-wealth-blue rounded-lg" />
    },
    {
      name: 'Index Fund',
      ...
      term: '5+ years',
      minInvestment: '$1,000',
      description: 'Passively managed fund tracking major market indices with lower fees.',
      icon: <BadgeDollarSign className="h-10 w-10 p-2 bg-blue-50 text-wealth-blue rounded-lg" />
    },
  ]
};
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-wealth-gray text-lg">
            Explore our diverse range of investment options designed to meet your financial goals, risk tolerance, and time horizons.
          </p>
        </div>
        ...
        <Tabs defaultValue="bonds" className="w-full" onValueChange={setActiveTab}>
          ...
          <div className="flex justify-center mt-10">
            <Button asChild variant="outline" className="group border-wealth-navy text-wealth-navy hover:bg-wealth-navy hover:text-white px-8">
