        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-up">
            ...
            <p className="text-lg md:text-xl text-wealth-gray max-w-md">
              Diversify your portfolio with our expert-managed investment
              products. Bonds, Treasury Bills, and more—all in one place.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Button
                asChild
                className="bg-wealth-navy hover:bg-wealth-blue text-white px-8 py-6 text-base"
              >
                <Link to="#">Explore Investments</Link>
              </Button>
            ...
            <div className="pt-4">
              <p className="text-sm text-wealth-gray font-medium">
                Trusted by investors worldwide
              </p>
              <div className="flex flex-wrap gap-6 mt-4 items-center">
                <div className="text-wealth-gray/60 font-semibold">
                  TRUSTED PARTNER
                </div>
                <div className="text-wealth-gray/60 font-semibold">
                  GLOBAL FINANCE
